...
const allStories = {
    ru: {
        part1: [
            ...
            {
                text: "Мы захватили одного. Звали его Ганс... Теперь он наш разведчик и исполнитель “мокрых” дел.\nПустили его в городскую мэрию — он клюнул мэра, тот увидел Бога и утонул в фонтане.",
                image: "assets/images/goose.webp",
                avatar: "hans",
                codex: "UNIT_HANS",
                music: "classical",
...
,
        ...
        part2: [
            ...
            },
            {
                ...
                image: "assets/images/goose_pizza.webp",
...
,
            {
                ...
                image: "assets/images/goose_lsd.webp",
                codex: "TOXIN_R3",
                music: "casino",
                choices: [
            ...
            },
            {
                ...
                image: "assets/images/goose_vodka.webp",
                music: "casino",
                choices: [
                    { text: "Завершить уровень / Terminate", nextStep: 999 }
                ]
        ...
        part3: [
            ...
            },
            {
                ...
                image: "assets/images/goose_angel.webp",
                music: "classical",
                choices: [
...
,
            {
                ...
                image: "assets/images/religious_goose.webp",
                music: "casino",
                choices: [
                    { text: "Завершить уровень / Terminate", nextStep: 999 }
                ]
            },
            {
                ...
                image: "assets/images/gasmask_women.webp",
                music: "rap",
                choices: [
                    { text: "Завершить уровень / Terminate", nextStep: 999 }
                ]
...
,
    ...
    de: {
        part1: [
            ...
            {
                text: "Wir haben eine gefangen. Nannten ihn Hans... Jetzt ist er unser Aufklärer und Spezialist für 'nasse' Angelegenheiten.\nWir ließen ihn ins Rathaus — er pickte den Bürgermeister, der Bürgermeister sah Gott und ertrank in einem Brunnen.",
                image: "assets/images/goose.webp",
                avatar: "hans",
                codex: "UNIT_HANS",
                music: "classical",
...
,
    ...
    es: {
        part1: [
            ...
            {
                text: "Capturamos a uno. Lo llamamos Hans... Ahora es nuestro explorador y especialista en 'trabajos sucios'.\nLo soltamos en el ayuntamiento: picoteó al alcalde, el alcalde vio a Dios y se ahogó en una fuente.",
                image: "assets/images/goose.webp",
                avatar: "hans",
                codex: "UNIT_HANS",
                music: "classical",
...
,
    ...
    zh: {
        part1: [
            ...
            {
                text: "我们捕获了一只。叫它汉斯……现在它是我们的侦察兵和“清除”专家。\n我们把它放进市政厅——它啄了市长，市长见到了上帝并溺死在喷泉里。",
                image: "assets/images/goose.webp",
                avatar: "hans",
                codex: "UNIT_HANS",
                music: "classical",

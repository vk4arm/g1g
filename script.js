...
const _legacyStoriesPlaceholder = {
    ...
    part2: [
        {
            ...
            image: "assets/images/part2_hans_intro.webp",
            music: "casino"
        },
        {
        ...
        },
        {
            ...
            image: "assets/images/part2_hans_weaponry.webp",
            music: "casino"
        },
        {
        ...
        },
        {
            ...
            image: "assets/images/part2_aila_intro.webp",
            music: "casino"
        },
        {
        ...
        },
        {
            ...
            image: "assets/images/part2_geese_meeting.webp",
            music: "casino"
        },
        {
        ...
        },
        {
            ...
            image: "assets/images/part2_geese_attack.webp",
            music: "casino"
        },
        {
        ...
        },
        {
            ...
            image: "assets/images/part2_aila_congress.webp",
            music: "casino"
        },
        {
    ...
    part3: [
        ...
        },
        {
            ...
            image: "assets/images/part3_execution_plot.webp",
            music: "casino"
        },
        {
        ...
        },
        {
            ...
            image: "assets/images/part3_attack.webp",
            music: "classical"
        },
        {
        ...
        },
        {
            ...
            image: "assets/images/part3_goose_mercy.webp",
            music: "classical"
        },
        {
            ...
            image: "assets/images/part3_aila.webp",
            music: "classical"
        },
        {
            ...
            image: "assets/images/part3_destroyed_hall.webp",
            music: "classical"
        },
        {
            ...
            image: "assets/images/part3_collapse.webp",
            music: "classical"
        },
        {
        ...
        },
        {
            ...
            image: "assets/images/part3_target_locked.webp",
            music: "rap"
        },
        {
...
const ACHIEVEMENTS_DATA = {
    "ACH_TRAIN": { title: "Билет в Один Конец", desc: "Угнать бронепоезд и протаранить бункер. (Часть 1)", icon: "assets/images/train_crash.webp" },
    "ACH_AMBUSH": { title: "Неоновый Бандит", desc: "Устроить лобовую атаку с базуками. (Часть 1)", icon: "assets/images/bandit_ambush.webp" },
    "ACH_PSYCHO": { title: "Кибер-Психоз", desc: "Подключить гуся к нейро-сети. (Часть 1)", icon: "assets/images/goose_neurotrip.webp" },
    "ACH_PIZZA": { title: "Пожиратель Пентагона", desc: "Взломать столовую и съесть пиццу. (Часть 2)", icon: "assets/images/goose_pizza.webp" },
    "ACH_LSD": { title: "Матричный Дым", desc: "Задействовать LSD-дымокол в Пентагоне. (Часть 2)", icon: "assets/images/goose_lsd.webp" },
    "ACH_VODKA": { title: "Генеральский Тост", desc: "Активировать спец-протокол 'Русская Водка'. (Часть 2)", icon: "assets/images/goose_vodka.webp" },
    "ACH_ANGEL": { title: "Еретик", desc: "Поддаться меметическому ангелу-гусыне. (Часть 3)", icon: "assets/images/goose_angel.webp" },
    "ACH_CULT": { title: "Прихожанин", desc: "Принять кибер-причастие от Гуся-Епископа. (Часть 3)", icon: "assets/images/religious_goose.webp" },
    "ACH_ESCAPE": { title: "Выживший", desc: "Сбежать в противогазе с остатками элиты. (Часть 3)", icon: "assets/images/gasmask_women.webp" },
};
...
function updateScene() {
    ...
    setTimeout(() => {
        ...
        setTimeout(() => {
            ...
            if (data.avatar) {
                avatarImage.src = `assets/avatars/${data.avatar}.webp`;
